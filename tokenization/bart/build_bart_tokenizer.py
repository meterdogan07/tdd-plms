...
def build_spiece_tokenizer(vocab_size):
    ...
    # Train tokenizer
    tokenizer.train([f"/kuacc/users/eacikgoz17/tdd/tdd-plms/data/splits/tdd-corpus-0{i}.txt" for i in range(10)], trainer=trainer)
    #tokenizer.train([f"/kuacc/users/asafaya19/tdd-corpora/tdd-corpus-0{i:02d}.txt" for i in range(17)], trainer=trainer)

...
class ModifyingDocuments:
    ...
    def modifying_documents(
        ...
        #print("MD: Finished normalization")
        ...
        #print("MD: Finished incorrect substrings")
...
class DatasetFiltering:
    ...
    def save_dataset(self):
        ...
        #ids = list(range(self.ds.shape[0]))
        #self.ds.add_column("id", ids)
